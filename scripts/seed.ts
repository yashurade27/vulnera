  ...
  const createdSubmissions = await Promise.all([
    prisma.submission.create({
      data: {
        ...
        bountyType: xssBounty.bountyType,
    ...
    prisma.submission.create({
      data: {
        ...
        bountyType: rateLimitBounty.bountyType,
    ...
    prisma.submission.create({
      data: {
        ...
        bountyType: defiVaultBounty.bountyType,
    ...
    prisma.submission.create({
      data: {
        ...
        bountyType: accessibilityBounty.bountyType,
    ...
    prisma.submission.create({
      data: {
        ...
        bountyType: pushReliabilityBounty.bountyType,
    ...
    prisma.submission.create({
      data: {
        ...
        bountyType: adminPortalBounty.bountyType,
